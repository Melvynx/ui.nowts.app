...
<CommandBlock 
	npmCommand="npx shadcn@latest add https://registry-nowts.vercel.app/r/better-auth-otp.json" 
	pnpmCommand="pnpm dlx shadcn@latest add https://registry-nowts.vercel.app/r/better-auth-otp.json" 
	yarnCommand="npx shadcn@latest add https://registry-nowts.vercel.app/r/better-auth-otp.json" 
	bunCommand="bunx --bun shadcn@latest add https://registry-nowts.vercel.app/r/better-auth-otp.json" 
/>
