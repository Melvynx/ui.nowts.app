...
<CommandBlock 
	npmCommand="npx shadcn@latest add https://registry-nowts.vercel.app/r/server-toast.json" 
	pnpmCommand="pnpm dlx shadcn@latest add https://registry-nowts.vercel.app/r/server-toast.json" 
	yarnCommand="npx shadcn@latest add https://registry-nowts.vercel.app/r/server-toast.json" 
	bunCommand="bunx --bun shadcn@latest add https://registry-nowts.vercel.app/r/server-toast.json" 
/>
