...
} from "@/components/next-top-loader";
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        <div className="flex gap-2">
          ...
          <Button onClick={() => done()}>Complete Loading</Button>
...
export function ManualControls() {
  const { start, done, setProgress, disable, enable, isEnable } =
    useNextTopLoaderStore();
...
export function Navigation() {
  return (
    <nav className="space-x-4">
      ...
      <Link href="/contact" data-toploader-disabled="true">
        Contact (No Loading)
      </Link>
